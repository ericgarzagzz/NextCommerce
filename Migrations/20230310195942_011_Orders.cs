...
{
    public partial class _011_Orders : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_Neighborhood = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ShippingAddress_PlainAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingAddress_PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShippingAddress_Instructions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingAddress_FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingAddress_Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingAddress_Neighborhood = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    BillingAddress_PlainAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingAddress_PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingAddress_Instructions = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitTaxes = table.Column<decimal>(type: "money", nullable: false),
