...
{
    public partial class _009_Taxes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BuyedWithProduct",
                columns: table => new
                {
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    BuyedWithId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuyedWithProduct", x => new { x.ProductId, x.BuyedWithId });
                    table.ForeignKey(
                        name: "FK_BuyedWithProduct_Products_BuyedWithId",
                        column: x => x.BuyedWithId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuyedWithProduct_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuyedWithProduct_BuyedWithId",
                table: "BuyedWithProduct",
                column: "BuyedWithId");
