        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SliderImageId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Categories_Images_SliderImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dimension_WeightInKilograms = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Dimension_WidthInCentimeters = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Dimension_HeightInCentimeters = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Dimension_DepthInCentimeters = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Images_SliderImageId",
                        column: x => x.SliderImageId,
                        principalTable: "Images",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_SliderImageId",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SliderImageId",
                table: "Products",
                column: "SliderImageId");
