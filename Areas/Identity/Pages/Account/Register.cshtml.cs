...
namespace NextCommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "La {0} debe tener al menos {2} y máximo {1} carácteres de longitud.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "La contraseñas no coinciden, deben ser iguales.")]
